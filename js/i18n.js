(()=>{
  ...
  const STORAGE_KEY='nswer-language';
  const CACHE_KEY='nswer-i18n-cache-v1';
  const JAPANESE_RE=/[\u3040-\u30ff\u3400-\u9fff々〆〤]/;
  const ATTRS=['aria-label','title','placeholder','alt'];
  const SKIP_SELECTOR='script,style,noscript,svg,path,code,pre,textarea,[translate="no"],[data-no-i18n],.logo';

  const translations={
    en:{
      'ホーム':'Home','サイト内検索':'Site Search','NMIXXについて':'About NMIXX','メンバー':'Members','スケジュール':'Schedule','ニュース':'News','音楽':'Music','ディスコグラフィ':'Discography','MV一覧':'MV List','応援ガイド':'Support Guide','ストリーミング':'Streaming','投票ガイド':'Voting Guide','掛け声ガイド':'Fan Chant Guide','リンク':'Links','公式リンク':'Official Links','テーマ切り替え':'Switch theme','メニューを開く':'Open menu','モバイルナビゲーション':'Mobile navigation',
      'NMIXXを日本から応援する非公式ファンベースです。':'An unofficial fanbase supporting NMIXX from Japan.','公式情報はNMIXXおよび所属事務所・各主催者の案内もあわせてご確認ください。':'Please also check announcements from NMIXX, the agency, and event organizers for official information.',
      ...
      '基本情報':'Basic Information','NMIXXの魅力':'What Makes NMIXX Special','MIXX POP':'MIXX POP','Live Performance':'Live Performance','メンバープロフィール':'Member Profiles','詳しく見る →':'View Details →','6人のメンバーを知る':'Meet the Six Members','メンバーを見る':'View Members','詳細プロフィールを見る':'View Full Profile','生年月日':'Date of Birth','出身地':'Hometown','本名':'Real Name','メンバーカラー':'Member Color','詳細プロフィール':'Full Profiles','ページ上部へ ↑':'Back to Top ↑','プロフィールを見る →':'View Profiles →',
      ...
      '同期状況':'Sync Status','確認中':'Checking','正常':'Healthy','要確認':'Needs Review','最終同期実行':'Last Sync Run','データ変更日時':'Data Updated','実行頻度':'Frequency','実行方法':'Trigger','手動実行先 ↗':'Run Manually ↗','最新ログ ↗':'Latest Log ↗','公開ページ →':'Public Page →','管理リンク':'Management Link','repository管理 ↗':'Manage in repository ↗',
      '公式情報を見る':'View Official Information','すべて見る →':'View All →','初めて来た方へ':'New Here?','まず見るページ':'Start Here','NMIXXを知る':'About NMIXX','6人を知る':'Meet the Members','音楽を聴く':'Listen to the Music','一緒に応援する':'Support Together','グループのコンセプトと歩み':'Group concept and journey','アルバム・シングル・MV':'Albums, singles, and MVs','ストリーミングと投票の基本':'Streaming and voting basics','最近追加・更新したガイド':'Recently Added & Updated Guides','最新情報まとめ':'Latest Updates','最新情報を見る':'View Latest Updates','公式情報':'Official Information',
      ...
      '記録':'Records','日本FC・公演ガイド':'Fan Service Guide','音楽番組1位獲得記録':'Music Show Wins','Melonチャート記録':'Melon Chart Records','楽曲別チャート記録':'Chart Records by Song','今月のスケジュール':'This Month’s Schedule','今日のスケジュール':'Today’s Schedule','月全体を表示':'Show Full Month','今日を表示':'Show Today','この日のスケジュールはありません。':'There are no events scheduled for this day.','この月に公開されている予定はありません。':'There are no published events for this month.','最終更新':'Last Updated','映像を見る ↗':'Watch Video ↗','関連リンクあり':'Related Link Available','詳細を見る':'View Details','Googleカレンダー':'Google Calendar','Apple・ICS':'Apple / ICS','この予定を共有':'Share This Event','共有':'Share','URLコピー':'Copy URL','音楽番組スケジュール':'Music Show Schedule','1週間の出演・投票タイミングをまとめた画像です。最新の予定は公式案内もあわせてご確認ください。':'A weekly overview of appearances and voting times. Please also check official announcements for the latest details.','掲載楽曲数':'Listed Tracks','通算1位回数':'Total Wins','日間最高順位':'Daily Peak','TOP100最高順位':'TOP100 Peak','獲得日':'Date Achieved','発売順':'Release Order','記録トップ':'Records Home','総獲得数と映像を見る →':'View Total Wins and Videos →','記録のカテゴリーへ戻る →':'Back to Record Categories →','公式映像をまとめて見る →':'View Official Videos →','公開作品':'Published releases','件':'items','人':'members','曲':'tracks','最終更新':'Last updated','読み込みエラー':'Load Error','再読み込み':'Reload','時間をおいて再読み込みしてください。':'Please try reloading later.'
    },
    ko:{
      'ホーム':'홈','サイト内検索':'사이트 검색','NMIXXについて':'NMIXX 소개','メンバー':'멤버','スケジュール':'스케줄','ニュース':'뉴스','音楽':'음악','ディスコグラフィ':'디스코그래피','MV一覧':'MV 목록','応援ガイド':'응원 가이드','ストリーミング':'스트리밍','投票ガイド':'투표 가이드','掛け声ガイド':'응원법 가이드','リンク':'링크','公式リンク':'공식 링크','テーマ切り替え':'테마 전환','メニューを開く':'메뉴 열기','モバイルナビゲーション':'모바일 내비게이션',
      'NMIXXを日本から応援する非公式ファンベースです。':'일본에서 NMIXX을 응원하는 비공식 팬베이스입니다.','公式情報はNMIXXおよび所属事務所・各主催者の案内もあわせてご確認ください。':'공식 정보는 NMIXX, 소속사 및 각 주최 측의 안내도 함께 확인해 주세요.',
      ...
      '基本情報':'기본 정보','NMIXXの魅力':'NMIXX의 매력','MIXX POP':'MIXX POP','Live Performance':'라이브 퍼포먼스','メンバープロフィール':'멤버 프로필','詳しく見る →':'자세히 보기 →','6人のメンバーを知る':'여섯 멤버 알아보기','メンバーを見る':'멤버 보기','詳細プロフィールを見る':'상세 프로필 보기','生年月日':'생년월일','出身地':'출신지','本名':'본명','メンバーカラー':'멤버 컬러','詳細プロフィール':'상세 프로필','ページ上部へ ↑':'페이지 위로 ↑','プロフィールを見る →':'프로필 보기 →',
      ...
      '同期状況':'동기화 상태','確認中':'확인 중','正常':'정상','要確認':'확인 필요','最終同期実行':'마지막 동기화 실행','データ変更日時':'데이터 변경 시간','実行頻度':'실행 주기','実行方法':'실행 방법','手動実行先 ↗':'수동 실행 ↗','最新ログ ↗':'최신 로그 ↗','公開ページ →':'공개 페이지 →','管理リンク':'관리 링크','repository管理 ↗':'repository 관리 ↗',
      '公式情報を見る':'공식 정보 보기','すべて見る →':'전체 보기 →','初めて来た方へ':'처음 방문하셨나요?','まず見るページ':'먼저 볼 페이지','NMIXXを知る':'NMIXX 알아보기','6人を知る':'여섯 멤버 알아보기','音楽を聴く':'음악 듣기','一緒に応援する':'함께 응원하기','グループのコンセプトと歩み':'그룹 콘셉트와 여정','アルバム・シングル・MV':'앨범·싱글·MV','ストリーミングと投票の基本':'스트리밍과 투표 기본','最近追加・更新したガイド':'최근 추가·업데이트된 가이드','最新情報まとめ':'최신 정보 모음','最新情報を見る':'최신 정보 보기','公式情報':'공식 정보',
      '曜日':'요일','土':'토','日':'일','月':'월','火':'화','水':'수','木':'목','金':'금','誕生日':'생일','記念日':'기념일','イベント':'이벤트','放送・その他':'방송·기타','お知らせ':'공지','リリース':'발매',
      '記録':'기록','日本FC・公演ガイド':'팬 서비스 가이드','音楽番組1位獲得記録':'음악방송 1위 기록','Melonチャート記録':'Melon 차트 기록','楽曲別チャート記録':'곡별 차트 기록','今月のスケジュール':'이번 달 스케줄','今日のスケジュール':'오늘의 스케줄','月全体を表示':'월 전체 보기','今日を表示':'오늘 보기','この日のスケジュールはありません。':'이 날짜의 스케줄은 없습니다.','この月に公開されている予定はありません。':'이 달에 공개된 스케줄은 없습니다.','最終更新':'마지막 업데이트','映像を見る ↗':'영상 보기 ↗','関連リンクあり':'관련 링크 있음','詳細を見る':'자세히 보기','Googleカレンダー':'Google 캘린더','Apple・ICS':'Apple·ICS','この予定を共有':'이 스케줄 공유','共有':'공유','URLコピー':'URL 복사','音楽番組スケジュール':'음악방송 스케줄','1週間の出演・投票タイミングをまとめた画像です。最新の予定は公式案内もあわせてご確認ください。':'일주일간의 출연·투표 시간을 정리한 이미지입니다. 최신 일정은 공식 안내도 함께 확인해 주세요.','掲載楽曲数':'수록 곡 수','通算1位回数':'통산 1위 횟수','日間最高順位':'일간 최고 순위','TOP100最高順位':'TOP100 최고 순위','獲得日':'달성일','発売順':'발매 순서','記録トップ':'기록 메인','総獲得数と映像を見る →':'총 1위 횟수와 영상 보기 →','記録のカテゴリーへ戻る →':'기록 카테고리로 돌아가기 →','公式映像をまとめて見る →':'공식 영상 모아보기 →','公開作品':'공개 작품','件':'건','人':'명','曲':'곡','最終更新':'마지막 업데이트','読み込みエラー':'불러오기 오류','再読み込み':'새로고침','時間をおいて再読み込みしてください。':'잠시 후 다시 불러와 주세요.'
    }
  };
  ...
  function translatedPattern(value,target){
    const text=String(value||'').trim();
    let match=text.match(/^(\d{4})年\s*(\d{1,2})月$/);
    if(match)return target==='ko'?`${match[1]}년 ${match[2]}월`:`${match[1]} ${new Intl.DateTimeFormat('en',{month:'long'}).format(new Date(2000,Number(match[2])-1,1))}`;
    match=text.match(/^(\d{1,2})月(\d{1,2})日のスケジュール$/);
    if(match)return target==='ko'?`${match[1]}월 ${match[2]}일 스케줄`:`Schedule for ${match[1]}/${match[2]}`;
    match=text.match(/^(\d{4})年(\d{1,2})月のスケジュール$/);
    if(match)return target==='ko'?`${match[1]}년 ${match[2]}월 스케줄`:`Schedule for ${match[1]}/${match[2]}`;
    match=text.match(/^最終更新[：:]\s*(.+)$/);
    if(match)return target==='ko'?`마지막 업데이트: ${match[1]}`:`Last Updated: ${match[1]}`;
    return '';
  }
  function translatedStatic(value,target){
    const patterned=translatedPattern(value,target);
  ...
  function init(){
    ...
    ['nswer:content-updated','nswer:content-rendered'].forEach(name=>document.addEventListener(name,()=>{if(currentLanguage!=='jp')applyLanguage(currentLanguage,{userActivated:false})}));
  }
