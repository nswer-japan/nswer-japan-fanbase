...
FORBIDDEN=[r'(?i)rescene',r'リセンヌ',r'리센느',r'(?i)notion',r'(?i)plus\s*chat',r'(?i)the\s+show',r'(?i)bigc',r'\bWONI\b',r'\bLIV\b',r'\bMINAMI\b',r'\bMAY\b',r'\bZENA\b',r'(?i)scenedrome',r'(?i)love\s+attack',r'(?i)pretty\s+girl',r'(?i)lip\s+bomb',r'(?i)busy\s+boy',r'(?i)glow\s+up',r'(?i)pinball',r'(?i)remember\s+a\s+scene',r'(?i)scent\s*·\s*scene',r'香りと記憶',r'香りを通じて',r'(?i)artist/nswer/',r'(?i)nswer-fb\.jp']
